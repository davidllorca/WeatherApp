...
import com.davidllorca.weatherapp.MainActivity;
import com.davidllorca.weatherapp.R;
import com.davidllorca.weatherapp.Utility;
...
public class WeatherAppSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String LOG_TAG = WeatherAppSyncAdapter.class.getSimpleName();

    // Interval at which to sync with the weather, in milliseconds.
    // 60 seconds (1 minute)  180 = 3 hours
    public static final int SYNC_INTERVAL = 50;//60 * 180;
    ...
    private static void setLocationStatus(Context context, @LocationStatus int locationStatus){
        ...
        preferencesEditor.putInt(context.getString(R.string.pref_location_status_key), locationStatus);
