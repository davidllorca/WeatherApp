...
import com.davidllorca.weatherapp.sync.WeatherAppSyncAdapter;
...
/**
 * Created by David Llorca <davidllorcabaron@gmail.com> on 7/6/16.
 */
...
public class Utility {
    ...
    public static
    @WeatherAppSyncAdapter.LocationStatus
    int getLocationStatus(Context context) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.getInt(context.getString(R.string.pref_location_status_key), WeatherAppSyncAdapter.LOCATION_STATUS_UNKNOWN);
    }

    public static void resetLocationStatus(Context context) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor preferencesEditor = preferences.edit();
        preferencesEditor.putInt(context.getString(R.string.pref_location_status_key), WeatherAppSyncAdapter.LOCATION_STATUS_UNKNOWN);
