...
public class WeatherProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;//Just one item
            case WEATHER_WITH_LOCATION:
                return WeatherContract.WeatherEntry.CONTENT_TYPE;//Many items
            case WEATHER:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // A null value deletes all rows. Only notify the uri listeners (using the //content resolver) if the rowsDeleted != 0 or the selection
        // is null.
